            ...
            <div class="col-md-6 bg-transparent">
                <?php
                    if(isset($_GET['search_key'])):
                        $keyword= $_GET['search'];
                        $searchResult=$conn->prepare("SELECT users.id, users.imgs, users.name, addpost.id, addpost.title, addpost.description FROM users INNER JOIN addpost ON users.id = addpost.user_id WHERE title like :keyword OR description LIKE :keyword");
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6 my-2">
                                <img src="uploads/<?php echo $row['imgs'];?>" class="rounded-circle" alt="Cinque Terre" width="50" height="50" >
                                <strong class="ms-0 mt-3 text-info"><?php echo $row['name'];?></strong><span class="ms-3 text-muted">25 min ago.</span>
                            </div>
                        </div>
                    </div>
                    <hr style="height:2px; width:100%; border-width:0;" class="shadow-block">
                    <div class="col-md-12">
                        <h5><a class="nounderline" href="single.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></h5>
